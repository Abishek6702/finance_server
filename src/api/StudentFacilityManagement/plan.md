...
src/api/StudentFacilityManagement/controller.StudentFacilityManagement.js
src/api/StudentFacilityManagement/service.StudentFacilityManagement.js
src/api/StudentFacilityManagement/validation.StudentFacilityManagement.js
src/api/StudentFacilityManagement/routes.StudentFacilityManagement.js
src/test/StudentFacilityManagement.test.js
Existing (modify):

server.js — require + app.use("/api/studentFacility", sfmRoutes) after existing routes
doc.StudentFacilityManagement.md — fill endpoint documentation
